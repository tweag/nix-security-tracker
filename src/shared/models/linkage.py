...
class CVEDerivationClusterProposalQuerySet(models.QuerySet):
    def active(self) -> "CVEDerivationClusterProposalQuerySet":
        """Return only proposals generated by the currently active algorithm version."""
        return self.filter(algorithm_version=self.model.CURRENT_ALGORITHM_VERSION)
