...
def test_bearer_auth_valid_token(user: User) -> None:
...
@pytest.mark.django_db
def test_bearer_auth_expired_token(user: User) -> None:
...
@pytest.mark.django_db
def test_bearer_auth_revoked_token(user: User) -> None:
    _, raw = _create_token(user)
